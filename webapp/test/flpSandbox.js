		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Bar Code Project",
									"targetURL": "#barcodeproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"barcodeproject-display": {
								"semanticObject": "barcodeproject",
								"action": "display",
								"description": "Bar Code Project",
								"title": "Bar Code Project",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=barcodeproject",
									"url": sap.ui.require.toUrl("barcodeproject")
								}
							}
						}
					}
